...
#ifndef __IBall_idl_h__
#define __IBall_idl_h__
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IBall_bounce_Proxy( 
    IBall * This);


void __RPC_STUB IBall_bounce_Stub(
    IRpcStubBuffer *This,
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IBall_roll_Proxy( 
    IBall * This,
    /* [in] */ long distance,
    /* [retval][out] */ long *ret_distance);


void __RPC_STUB IBall_roll_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
