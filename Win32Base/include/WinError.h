...
enum {
  ...
  STG_E_INCOMPLETE = (HRESULT)0x80030201L,
  STG_E_TERMINATED = (HRESULT)0x80030202L,
  CO_E_LAUNCH_PERMSSION_DENIED = (HRESULT)0x8000401bL,
  DIGSIG_E_ENCODE = (HRESULT)0x800b0005L,
  DIGSIG_E_DECODE = (HRESULT)0x800b0006L,
  DIGSIG_E_EXTENSIBILITY = (HRESULT)0x800b0007L,
  DIGSIG_E_CRYPTO = (HRESULT)0x800b0008L,
  ...
  CERT_E_PATHLENCONST = (HRESULT)0x800b0104L,
  CERT_E_CRITICAL = (HRESULT)0x800b0105L,
  CERT_E_PURPOSE = (HRESULT)0x800b0106L,
  CERT_E_ISSUERCHAINING = (HRESULT)0x800b0107L,
...
// End copied code from Wine's winerror.h
